...
interface EditDriverModal2Props {
  isOpen: boolean;
  onClose: () => void;
...
const EditDriverModal2 = ({ isOpen, onClose, onSave, driver }: EditDriverModal2Props) => {
  ...
  useEffect(() => {
    if (driver) {
      setFormData({
        ...
        drivingHours: {
          weekly: driver.drivingHours.weekly,
          biWeekly: driver.drivingHours.biWeekly,
          monthly: driver.drivingHours.monthly
        }
      });
    }
  }, [driver]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      onSave({
        ...
        id: formData.id,
        drivingHours: {
          weekly: Number(formData.drivingHours.weekly),
          biWeekly: Number(formData.drivingHours.biWeekly),
          monthly: Number(formData.drivingHours.monthly)
        }
      } as Driver);
      onClose();
    }
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>Modifica Autista</h2>
          <button
            onClick={onClose}
            style={{
        ...
        <form onSubmit={handleSubmit} style={{ padding: '1.5rem' }}>
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            <h3 style={{ fontSize: '1rem', fontWeight: 500, marginBottom: '1rem' }}>Ore di Guida</h3>
...
export default EditDriverModal2;
