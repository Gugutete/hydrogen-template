...
const EditBusModal2 = ({ isOpen, onClose, onSave, bus }: EditBusModal2Props) => {
  ...
  useEffect(() => {
    if (bus) {
      setFormData({
        ...
        documentsStatus: bus.documentsStatus
      });
    }
  }, [bus]);
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>Modifica Bus</h2>
          <button
            onClick={onClose}
            style={{
